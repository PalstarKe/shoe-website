        ...
        <div className="flex flex-col items-center p-4 sm:p-8 lg:flex-row lg:justify-between">
          ...
          <div className="flex flex-col items-center lg:items-end">
            <form className="mb-3 flex w-full max-w-md gap-2">
              <input placeholder="Email" className="bg-gray-white w-full flex-1 rounded border border-gray-300 px-3 py-2 text-gray-800 placeholder-slate-gray outline-none ring-orange-500 transition duration-100 focus:ring" />

              <button className="inline-block rounded bg-orange-500 px-8 py-2 text-center text-sm font-semibold text-white outline-none ring-indigo-300 transition duration-100 hover:bg-orange-500 focus-visible:ring active:text-orange-500 md:text-base">Send</button>
            </form>

            <p className="text-center text-xs text-slate-gray lg:text-right">By signing up to our newsletter you agree to our <a href="#" className="underline transition duration-100 hover:text-orange-500 active:text-orange-500">Term of Service</a> and <a href="#" className="underline transition duration-100 hover:text-coral-red active:text-coral-red">Privacy Policy</a>.</p>
          </div>
        </div>
      </div>
    </div>
