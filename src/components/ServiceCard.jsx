const ServiceCard = ({ imgURL, label, subtext }) => {
  return (
    <div className="flex flex-1 flex-row justify-center items-center gap-6 sm:w-[350px] sm:min-w[350px] w-full rounded-[20px] shadow-3xl px-4 py-6">
      ...
      <div>
        <h3 className="mt-5 font-palanquin text-2xl lg:text-3xl leading-normal font-bold">
          {label}
        </h3>
        <p className="mt-2 break-words font-montserrat text-info leading-normal text-slate-gray">
          {subtext}
        </p>
      </div>
    </div>
